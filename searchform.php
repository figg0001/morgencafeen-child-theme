...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="search-field" <?php echo esc_attr( $astra_search_data_attrs ); ?> placeholder="<?php echo esc_attr__( 'Søg...', 'astra' ); ?>" value="<?php echo esc_attr( $astra_search_input_value ); ?>" name="s" tabindex="-1">
